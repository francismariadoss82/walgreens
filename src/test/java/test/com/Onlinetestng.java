...
public class Onlinetestng {
    ...
    public void testWalgreensonline() throws Exception {
        ...
        //driver.findElement(By.xpath("//*[@id=\"proceedtocheckout\"]")).click();
    driver.findElement(By.xpath("//*[@id=\"passwordlessLoginContainer\"]/section[4]/section[2]/section[1]/section[1]/section/section[4]/section/button")).click();
    ...
    driver.findElement(By.id("wag-cko-id-sa-inp-add")).sendKeys("11 westfield");
    driver.findElement(By.id("wag-cko-id-sa-inp-city")).click();
    driver.findElement(By.id("wag-cko-id-sa-inp-city")).clear();
    driver.findElement(By.id("wag-cko-id-sa-inp-city")).sendKeys("desplaines");
    ...
    driver.findElement(By.id("wag-cko-pm-in-cc-num")).sendKeys("5467005860958200");
   // new Select(driver.findElement(By.id("wag-cko-pm-sel-cc-exp-mon"))).selectByVisibleText("09 - Sep");
   // new Select(driver.findElement(By.id("wag-cko-pm-sel-cc-exp-year"))).selectByVisibleText("2022");
    driver.findElement(By.id("wag-cko-pm-lb-sasadd")).click();
    driver.findElement(By.id("wag-cko-sa-id-btn-sel-g")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='‹ Back to cart'])[1]/following::section[1]")).click();
